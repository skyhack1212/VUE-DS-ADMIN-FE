      ...
      <el-tabs type="border-card" v-model="activeTab">
        ...
        <el-tab-pane name="tab1" label="用户信息">
          ...
          <el-form class="form-user--info" ref="userForm" :model="userForm" :rules="userRule" label-width="80px">
            <el-form-item label="用户名" prop="name">
              <el-input v-model="userForm.name" :disabled="id?true:false"></el-input>
            </el-form-item>
            ...
            <el-form-item label="">
              <router-link :to="{ path:'/user/list'}">
                ...
                <!-- <el-button type="primary" class="btn-long" @click="handleSubmitInfo" disabled >暂不支持编辑</el-button> -->
              </router-link>
            </el-form-item>
          </el-form>
        </el-tab-pane>
        ...
        <el-tab-pane name="tab2" label="权限设置" :disabled="authDisabled" v-if="!isAdmin">
          ...
          <el-form class="form-user--auth" ref="userAuthForm" label-width="10px">
            ...
            <el-form-item>
              <el-button type="primary" style="margin-top: 12px;" class="btn-long" @click="handleSubmitAuth" disabled>
                <!-- <span>保存用户权限</span> -->
                <span>暂不支持编辑，默认具有所有权限</span>
              </el-button>
            </el-form-item>
          </el-form>
        </el-tab-pane>
