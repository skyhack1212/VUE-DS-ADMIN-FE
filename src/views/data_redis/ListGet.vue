  ...
  <div class="page-wrapper">
    ...
    <div class="page-breadcrumb">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item :to="{ path: '/data_redis/list' }">数据查询</el-breadcrumb-item>
        <el-breadcrumb-item>测试redis查询</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <!--主内容区-->
    <div class="page-main">
        <el-form ref="form" :rules="rules" :model="form" label-width="80px" highlight-current-row v-loading="loading" element-loading-text="数据请求中" >
          <el-form-item label="redis菜单" prop="level">
            <el-select v-model="interface" placeholder="客官，想吃啥自选" @change="changed" style="width:500px">
            <!-- <el-select v-model="interface" v-if="options[0].value == '/get_redis_list'" :placeholder="options[0].label" style="width:500px"> -->
              <el-option
  ...
  export default{
    ...
    data () {
      return {
        ...
        options: [
          {
            value: '/get_redis_list',
            label: '1、获取测试环境redis/pika列表: get_redis_list'
          }
        ],
